...
public class SageIntacctService : ISageIntacctService
{
    ...
    public async Task<string> GetAccessTokenAsync()
    {
        ...
        //     throw;
        // }
        //_logger.LogInformation($"AuthCode: {_config.AuthCode}"); // Added log

        return _config.AuthCode;
    }
    ...
    public async Task<string> GetVendorsAsync(string accessToken)
    {
        ...
        try
        {
            ...
            var request = await _httpClient.GetAsync("https://api.intacct.com/ia/api/v1/objects/accounts-payable/vendor");
